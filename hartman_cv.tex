...
\section{Brief Bio}
Computational psychologist specializing in the development and application of advanced quantitative methods in the social sciences (e.g., network analysis, latent variable modelling, the design and analysis of complex surveys and experiments). Research investigates the psychological underpinnings of public opinion and mass behaviour and has been featured in media outlets like \textit{The Washington Post}, \textit{The Guardian}, \textit{The Independent}, and \textit{The Economist}.\\
Citations: 6,105; \href{https://harzing.com/resources/publish-or-perish/tutorial/metrics/h-and-g-index}{\textit{g}-index}: 78; 
\href{https://guides.library.cornell.edu/impact/author-impact-10}{\textit{i}-index}: 49; 
\href{https://harzing.com/resources/publish-or-perish/tutorial/metrics/h-and-g-index}{\textit{h}-index: 31}.

\halfblankline

\section{Current Appointments}
Head of Department (Social Statistics), {University of Manchester} \hfill {2025\,--\,}
...
Economic and Social Research Council (ESRC) Peer Review College \hfill {2024\,--\,}

\halfblankline

\section{Previous Appointments}
Deputy Director, Cathie Marsh Institute, School of Social Sciences  \hfill {2022\,--\,25}

Daniel B. German Distinguished Professor, \href{https://gjs.appstate.edu/}{Appalachian State Un} \hfill {2022\,--\,23}
...
Deputy Director, Cathie Marsh Institute, School of Social Sciences\hfill {2022\,--\,25}\\
Director of Teaching \& Learning, Department of Social Statistics  \hfill {2024\,--\,25}\\
Executive Board Member, Sheffield Methods Institute  \hfill {2014\,--\,21}\\
Director, Sheffield Q-Step Centre (Funded Budget: £1,408,879) \hfill {2017\,--\,21}\\
...
Director (Founding), BA/BSc in Politics, Philosophy \& Economics \hfill {2019\,--\,21}
	...
	\end{innerlist}
Convenor, Political Psychology Specialist Group, PSA  \hfill {2019\,--\,22}
	\begin{innerlist}
...
Associate Editor, \emph{Political Studies}  \hfill {2020\,--\,23}\\
...
\begin{bibenum}    
\item Wilner, P., {Hartman, T. K.} \& Bentall, R., P. 
	(2022, September 5).
	\href{https://blogs.lse.ac.uk/politicsandpolicy/freedom-of-movement-leavers-remainers/}
	{New research shows freedom of movement is not toxic to 
	Leavers, who are almost as positive about it as Remainers}. 
	[Blog post]. 
	\textit{British Politics and Policy, 
	London School of Economics and Political Science}.

\item Bentall, R., P., Wilner, P., \& {Hartman, T. K.}. 
	(2022, March 30).
	\href{https://blogs.lse.ac.uk/politicsandpolicy/brexit-psychology-new-deal-europe/}
	{A party which supported a new deal with Europe 
	would likely benefit at the ballot box by support 
	from both Leavers and Remainers}. [Blog post]. 
	\textit{British Politics and Policy, 
	London School of Economics and Political Science}.
...
\begin{bibsection}
	\item \textbf{Total income: \textsterling3,260,517}
	
		\item ``What can bureaucratic justice do for mental health?'' funded by the Wellcome Trust (2026-32). Co\-/I with Joe Tomlinson (KCL), Line Gega (York), Annie Irvine (York), Simona Manni (York), Jed Meers (York), and Aisling Ryan (York). \textbf{Award: \textsterling2,495,819}. 
	...
	\item ``Advancing political psychological research from the COVID-19 Psychological Research Consortium (C19PRC) Study,'' funded by the School of Social Sciences Research Support Funds (2021-22), The University of Manchester. PI. \textbf{Award: \textsterling10,000}. 

\item ``A longitudinal mixed-methods population study of the UK during the COVID-19 pandemic: Psychological and social adjustment to global threat,'' funded by the Economic and Social Research Council. (2020). Co\-/I with Richard Bentall (PI; Sheffield), Kate Bennett (Liverpool), Jilly Gibson Miller (Sheffield), Liat Levita (Sheffield), Liam Mason (UCL), Orla McBride (Ulster), Jamie Murphy (Ulster), \& Mark Shevlin (Ulster). \textbf{Award: \textsterling376,792}. 

	\item ``Q-Step transitional funding 2019-2021,'' funded by the Nuffield Foundation and ESRC. (2019). PI. \textbf{Award: \textsterling123,554}.

	\item ``Data trust project,'' funded by the BBC. (2019). Co\-/I with 
	Helen Kennedy (PI; Sheffield). \textbf{Award: \textsterling20,000}. 
	
	    \item ``Pushing the Boundaries Award,'' funded by the Political Studies Association to organise an interdisciplinary conference in political psychology. (2019). With Donatella Bonansinga, Raynee Gutting, and James Weinberg. Award: \textbf{\textsterling2,000}. 
	...
	the UK Ministry of Justice. 
 	(2018). Co\-/I with Nathan Hughes (PI; Sheffield). \textbf{Award: \textsterling35,110}.
   ...
   (2015). Co\-/I with Liam Stanley (PI; Sheffield) \& Leonard 
	...
	The University of Sheffield. (2015). Co\-/I with Liam Stanley (PI; Sheffield). \textbf{Award: \textsterling3,300}.
...
\emph{Current PhD Students}
	\begin{innerlist}
		\item[-] Kristians Pranevskis (\href{https://nwssdtp.ac.uk/collaboration/case-studentships/}{CASE})
		
		\item[-] Ahmed Kamala (\href{https://www.bmh.manchester.ac.uk/study/research/funding-fees/funded-programmes/esrc-nwss-dtp/}{NWSSDTP - ESRC})	
		
		\item[-] Maria Fleitas-Delgado
...
\begin{longtable}{@{}p{3.5cm}@{}l}%
   \multicolumn{2}{l}{\textit{Selected Invited Talks}}\\    	
   		 2024  & {``Applying network models to attitudinal surveys: mapping the}\\
  		  &  {structure of belief and value systems in the mass
public''}, \\ 
		& Ulster University\\   
...
\emph{Research Methods}
    \begin{innerlist}
     		...
     		\item[] Applied Statistics for Social Scientists 
     		(Using R) (UG)
    	        	\begin{innerlist}
        		    	\item[] [SP23, SP24]
        		    \end{innerlist}    
        ...
        \item[] Lies, Damned Lies, and Statistics (UG)
 		...
 		\item[] Quantitative Evaluation of Policies, 
 		Interventions, and Experiments (UG/PG)
    	        	\begin{innerlist}
        		    	\item[] [SP24, SP25]
        		    \end{innerlist}    
...
\emph{Political Psychology}
    \begin{innerlist}
        ...
        \item[] Political Psychology (UG, PG)
    	        	\begin{innerlist}
        		    	\item[] [AU06, AU09, AU10, SP11, AU12, AU13, SP23]
        		    \end{innerlist}
...
\section{Academic\\ Service}
    \emph{at The University of Manchester}
        \begin{innerlist}
        \item[] Deputy Director, Cathie Marsh Institute, 2022--
        \item[] Pathway Director, BA in Economics and Data Analytics, 2021--22
        \item[] Search Committee Member, L in Social Statistics, 2023
        \item[] Search Committee Member, Head of Department, 2022
        \item[] Search Committee Member, L/SL in Social Nework Analysis, 2022
        \item[] Search Committee Member, L in Social Statistics, 2022
        \end{innerlist}
